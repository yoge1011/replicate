...
export const ProfileComponent = ({ match }) => {
    const data = usersData.filter( user => user.id == match.params.id)[0].features
    return (
        <div>
            <h1>Feature</h1>
            {
                    ...
                    <div className='feature-card' key={feature.id}>
                        <div className='content'>
                            ...
                            <div className='cont-img'>
                                <div className='img'>
                                    <img className="cont-img-img" srcSet={feature.srcSet} sizes="700px" role="presentation" />
                                </div>
